...
vim.opt.backupcopy = 'yes'      -- If backupcopy is set to yes, Vim will always create the backup file by copying the original file. In this case inotifywait is able to monitor the file.
